            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form role="form" method="POST" action="submit_replace_mastor.php" enctype='multipart/form-data'>
                                    <input type="hidden" name="id" value="<?php echo $mastorInfor[0] ?>">
                                    <b>Last Head Master</b>
                                    <hr>
                                    <b>Name:</b><?php echo "$mastorInfor[2] $mastorInfor[3]" ?><br><br>
                                    <div class="form-group">
                                        <label>Finish Date</label>
                                        <input type="date" class="form-control" name="end">
                                    </div>
                                    <br>
                                    <b>New Head Mastor Info</b>
                                    <hr>
                                    <div class="form-group">
